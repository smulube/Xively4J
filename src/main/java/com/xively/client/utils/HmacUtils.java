...
public class HmacUtils {
    ...
    /**
     * Generate a device activation code given a product secret and device
     * serial.
     *
     * This just calls {@link HmacUtils#hmacSha1(String, String)}.
     *
     * @param productSecret
     * @param deviceSerial
     * @return
     */
    public static String activationCode(String productSecret,
            String deviceSerial) {
        return hmacSha1(productSecret, deviceSerial);
    }
